...
const keywordsByLocale: Record<string, string> = {
  ko: '라라벨, Laravel, PHP 프레임워크, 웹 개발, 한글 문서, 튜토리얼, 시작하기',
  en: 'Laravel, PHP framework, web development, documentation, tutorial, getting started',
  ja: 'Laravel, PHPフレームワーク, ウェブ開発, ドキュメント, チュートリアル, はじめに',
};
