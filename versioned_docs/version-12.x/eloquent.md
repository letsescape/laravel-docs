...
Eloquent 모델을 다룰 때 Laravel [aggregate methods](/docs/12.x/queries#aggregates)가 제공하는 `count`, `sum`, `max` 및 기타 [query builder](/docs/12.x/queries)도 사용할 수 있습니다. 예상할 수 있듯이, 이 메서드들은 Eloquent 모델 인스턴스가 아니라 스칼라 값을 반환합니다.
