...
`Log` [파사드](/docs/12.x/facades)를 통해 로그에 내용을 기록할 수 있습니다. 앞에서 설명했듯, [RFC 5424 명세](https://tools.ietf.org/html/rfc5424) 기준 8가지 로그 레벨에 맞는 메서드가 제공됩니다: **emergency**, **alert**, **critical**, **error**, **warning**, **notice**, **info**, **debug**
