...
> [!WARNING]
> pluralizer의 언어를 변경하는 경우, 반드시 Eloquent 모델의 [table names](/docs/12.x/eloquent#table-names)을 명시적으로 정의해야 합니다.
...
[Blade templating engine](/docs/12.x/blade)에서는 `{{ }}` 출력 구문을 활용할 수 있습니다:
