...
이 메서드는 [views](/docs/12.x/views)과 같은 그리드 시스템으로 작업할 때 [Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/)에서 특히 유용합니다. 예를 들어 그리드에 표시하려는 [Eloquent](/docs/12.x/eloquent) 모델 컬렉션이 있다고 가정해 보겠습니다.
