...
Laravel `Hash` [facade](/docs/12.x/facades)는 사용자 비밀번호 저장을 위한 안전한 Bcrypt와 Argon2 해싱을 제공합니다. [Laravel application starter kits](/docs/12.x/starter-kits)를 사용하는 경우, 기본적으로 가입 및 인증 시 Bcrypt가 사용됩니다.
