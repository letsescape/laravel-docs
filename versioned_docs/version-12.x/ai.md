...
Boost는 Model Context Protocol을 지원하는 주요 IDE와 AI 도구와 통합할 수 있습니다. Cursor, Claude Code, Codex, Gemini CLI, GitHub Copilot, Junie 등과의 상세한 연동 방법은 Boost 문서의 [Set Up Your Agents](/docs/12.x/boost#set-up-your-agents) 섹션을 참고하세요.
