---
title: 프론트엔드 (Frontend) - Laravel 12.x 한국어 문서
description: '라라벨은 라우팅, 유효성 검증, 캐시, 큐, 파일 저장소 등 현대적인 웹 애플리케이션을 개발하는 데 필요한 모든 기능을 갖춘 백엔드 프레임워크입니다. 하지만 저희는 개발자에게 강력하면서도 아름다운 풀스택 경험을 제공하는 것이 중요하다고 믿으며, 애플리케이션의 프론트엔드를...'
keywords: [라라벨 프론트엔드, Laravel frontend, Laravel 12.x]
---
# 프론트엔드 (Frontend)
