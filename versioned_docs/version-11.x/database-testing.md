...
테스트를 진행할 때 데이터베이스에 테스트용 레코드를 미리 삽입해야 할 때가 있습니다. 이때, 각 컬럼 값을 일일이 지정하는 대신, Laravel에서는 [Eloquent models](/docs/11.x/eloquent)를 활용해 각 [model factories](/docs/11.x/eloquent-factories)마다 기본 속성(attribute) 집합을 정의할 수 있습니다.
