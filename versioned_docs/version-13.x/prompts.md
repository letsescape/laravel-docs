...
Laravel Prompts는 [Artisan 콘솔 명령어](/docs/13.x/artisan#writing-commands)에서 사용자 입력을 받을 때 매우 적합하지만, 어떤 명령줄 PHP 프로젝트에서도 사용할 수 있습니다.

> [!NOTE]
> Laravel Prompts는 macOS, Linux, 그리고 WSL을 사용하는 Windows를 지원합니다. 자세한 내용은 [지원되지 않는 환경과 대체 동작](#fallbacks)에 대한 문서를 참고하십시오.
