...
일반적으로 [서비스 프로바이더](/docs/13.x/providers)의 `boot` 메서드에서 컬렉션 매크로를 선언해야 합니다.
...
이 메서드는 [Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/)과 같은 그리드 시스템으로 작업할 때 [뷰](/docs/13.x/views)에서 특히 유용합니다. 예를 들어 그리드에 표시하려는 [Eloquent](/docs/13.x/eloquent) 모델 컬렉션이 있다고 가정해 보겠습니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-contains)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-diff)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-except)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-intersect)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-only)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-partition)과 상호 작용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent 컬렉션](/docs/13.x/eloquent-collections#method-unique)을 사용할 때 수정됩니다.
...
이 메서드의 사용법을 설명하기 위해 커서를 사용하여 데이터베이스에서 송장을 제출하는 애플리케이션을 상상해 보십시오. 15분마다 실행되고 최대 14분 동안만 송장을 처리하는 [예약된 작업](/docs/13.x/scheduling)을 정의할 수 있습니다.
