...
[Laravel Sail](/docs/13.x/sail)을 사용하여 애플리케이션을 개발할 계획이라면, 다음 명령어들로 Octane 및 FrankenPHP를 설치하세요:
...
[Laravel Sail](/docs/13.x/sail)을 사용하여 애플리케이션을 개발할 경우, Octane과 RoadRunner를 다음 명령어로 설치합니다:
...
또는 [Laravel Sail](/docs/13.x/sail)이라는 공식 Docker 기반 개발 환경을 사용하여 Swoole 기반 Octane 애플리케이션을 개발할 수도 있습니다. Laravel Sail에는 기본적으로 Swoole 확장이 포함되어 있습니다. 하지만 Sail에서 사용하는 `docker-compose.yml` 파일에는 별도 설정이 필요합니다.
