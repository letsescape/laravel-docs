...
-->
[Using Eloquent](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/eloquent-models/)을 사용하면 모델을 MongoDB 컬렉션에 저장할 수 있습니다. 일반적인 Eloquent 기능 외에도 Laravel MongoDB 패키지는 embedded relationships와 같은 추가 기능을 제공합니다. 또한 MongoDB 드라이버에 직접 접근할 수 있어 raw queries나 aggregation pipelines 같은 작업을 실행할 수 있습니다.

[Write complex queries](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/query-builder/)는 query builder를 사용해 작성할 수 있습니다.

[Similarity / vector search](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/fundamentals/vector-search/)는 vector embeddings와 `vectorSearch` Eloquent 메서드를 사용합니다.

`mongodb` [cache driver](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/cache/)는 TTL indexes와 같은 MongoDB 기능을 사용해 만료된 캐시 항목을 자동으로 지우도록 최적화되어 있습니다.

`mongodb` queue driver로 [Dispatch and process queued jobs](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/queues/)를 처리하고 실행할 수 있습니다.

[Storing files in GridFS](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/filesystems/)는 [GridFS Adapter for Flysystem](https://flysystem.thephpleague.com/docs/adapter/gridfs/)를 통해 사용할 수 있습니다.

[Full-text search](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/scout/)는 `mongodb` Scout engine을 사용합니다.
