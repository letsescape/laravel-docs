...
저희는 라라벨을 "발전형(Progressive)" 프레임워크라 부릅니다. 즉, 라라벨은 여러분의 성장 단계에 따라 함께 발전할 수 있습니다. 웹 개발 입문 시에도 방대한 문서, 안내서, [비디오 튜토리얼](https://laracasts.com) 등 풍부한 리소스가 제공되어 부담 없이 기초부터 학습할 수 있습니다.
