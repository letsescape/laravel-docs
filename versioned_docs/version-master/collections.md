...
일반적으로 [service provider](/docs/master/providers)의 `boot` 메서드에서 컬렉션 매크로를 선언해야 합니다.
...
이 메서드는 [views](https://getbootstrap.com/docs/5.3/layout/grid/)과 같은 그리드 시스템으로 작업할 때 [Bootstrap](/docs/master/views)에서 특히 유용합니다. 예를 들어 그리드에 표시하려는 [Eloquent](/docs/master/eloquent) 모델 컬렉션이 있다고 가정해 보겠습니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-contains)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-diff)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-except)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-intersect)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-only)을 사용할 때 수정됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent collections](/docs/master/eloquent-collections#method-partition)과 상호 작용할 때 수정됩니다.
...
`toArray` 메서드는 컬렉션을 일반 PHP `array`로 변환합니다. 컬렉션의 값이 [Eloquent](/docs/master/eloquent) 모델인 경우 모델도 배열로 변환됩니다.
...
> [!NOTE]
> 이 메서드의 동작은 [Eloquent Collections](/docs/master/eloquent-collections#method-unique)을 사용할 때 수정됩니다.
...
이 메서드의 사용법을 설명하기 위해 커서를 사용하여 데이터베이스에서 송장을 제출하는 애플리케이션을 상상해 보십시오. 15분마다 실행되고 최대 14분 동안만 송장을 처리하는 [scheduled task](/docs/master/scheduling)을 정의할 수 있습니다.
