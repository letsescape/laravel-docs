...
> [!WARNING]
> Laravel Mix는 더 이상 활발하게 유지 관리되지 않는 레거시 패키지입니다. 현대적인 대안으로 [Vite](/docs/master/vite)를 사용할 수 있습니다.
...
> [!NOTE]
> Vite는 새로운 Laravel 설치 환경에서 Laravel Mix를 대체하고 있습니다. Mix 문서는 [official Laravel Mix](https://laravel-mix.com/) 웹사이트를 참고하세요. Vite로 전환하려면 [Vite migration guide](https://github.com/laravel/vite-plugin/blob/main/UPGRADE.md#migrating-from-laravel-mix-to-vite)를 참고하시기 바랍니다.
