...
macOS 10.14부터 [일부 파일 및 디렉토리에 대한 접근 권한이 기본적으로 제한됩니다](https://manuals.info.apple.com/MANUALS/1000/MA1902/en_US/apple-platform-security-guide.pdf). 여기에는 바탕화면, 문서, 다운로드 디렉토리뿐 아니라 네트워크 볼륨 및 외장 볼륨이 포함됩니다. 따라서 Valet를 사용할 때는 이러한 위치 외부에 사이트 폴더를 두는 것이 권장됩니다.
