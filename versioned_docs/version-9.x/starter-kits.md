...
Laravel Breeze의 기본 뷰 레이어는 [Blade templates](/docs/9.x/blade)로 스타일링된 심플한 [Tailwind CSS](https://tailwindcss.com)으로 구성되어 있습니다. 상황에 따라 Vue, React, 그리고 [Inertia](https://inertiajs.com)를 활용한 옵션도 지원합니다.
