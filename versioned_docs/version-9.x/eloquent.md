...
Eloquent 모델을 사용할 때도, Laravel [aggregate methods](/docs/9.x/queries#aggregates)에서 제공하는 `count`, `sum`, `max` 등 [query builder](/docs/9.x/queries)를 사용할 수 있습니다. 이 메서드들은 Eloquent 모델 인스턴스가 아닌 스칼라 값을 반환합니다.
