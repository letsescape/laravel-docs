...
라라벨에서는 애플리케이션의 [캐시](/docs/10.x/cache)와 함께 사용할 수 있는 단순한 요청 제한(rate limiting) 추상화 기능을 제공합니다. 이를 통해 지정한 시간 동안 어떤 작업이 허용되는지 손쉽게 제한할 수 있습니다.

> [!NOTE]
> 만약 외부에서 들어오는 HTTP 요청에 대한 속도 제한이 궁금하다면, [속도 제한 미들웨어 문서](/docs/10.x/routing#rate-limiting)를 참고하시기 바랍니다.
