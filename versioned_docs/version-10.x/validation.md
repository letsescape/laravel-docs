...
내부적으로 `Password` 규칙 객체는 [k-Anonymity](https://haveibeenpwned.com) 서비스를 활용하며, [haveibeenpwned.com](https://en.wikipedia.org/wiki/K-anonymity) 모델을 통해 사용자의 프라이버시와 보안을 해치지 않고 유출 여부를 판단합니다.
