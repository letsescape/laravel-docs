...
この方法は、[views](/docs/12.x/views) で、[Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/) などのグリッド システムを操作する場合に特に便利です。たとえば、グリッドに表示したい [Eloquent](/docs/12.x/eloquent) モデルのコレクションがあるとします。
