...
この方法は、[views](/docs/12.x/views) などのグリッド システムを操作する場合、[Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/) で特に便利です。たとえば、グリッドに表示したい [Eloquent](/docs/12.x/eloquent) モデルのコレクションがあるとします。
