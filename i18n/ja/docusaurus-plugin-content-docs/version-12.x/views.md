...
- [Introduction](#introduction)
    - [React / Svelte / Vue でのビューの作成](#writing-views-in-react-svelte-or-vue)
...
私たちの [React、Svelte、および Vue アプリケーション スターター キット](/docs/{{version}}/starter-kits) は、Inertia を利用した次の Laravel アプリケーションの優れた出発点となります。
