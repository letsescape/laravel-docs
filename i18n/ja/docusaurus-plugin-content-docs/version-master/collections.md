...
> [!NOTE]
> [Eloquent](/docs/master/eloquent) クエリの結果は、常に `Collection` インスタンスとして返されます。
...
通常、コレクション マクロは、[service provider](/docs/master/providers) の `boot` メソッドで宣言する必要があります。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-contains) を使用すると、このメソッドの動作が変更されます。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-diff) を使用すると、このメソッドの動作が変更されます。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-except) を使用すると、このメソッドの動作が変更されます。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-intersect) を使用すると、このメソッドの動作が変更されます。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-only) を使用すると、このメソッドの動作が変更されます。
...
> [!NOTE]
> このメソッドの動作は、[Eloquent collections](/docs/master/eloquent-collections#method-partition) と対話するときに変更されます。
...
`toArray` メソッドは、コレクションをプレーンな PHP `array` に変換します。コレクションの値が [Eloquent](/docs/master/eloquent) モデルの場合、モデルも配列に変換されます。
...
> [!NOTE]
> [Eloquent Collections](/docs/master/eloquent-collections#method-unique) を使用すると、このメソッドの動作が変更されます。
...
このメソッドの使用法を説明するために、カーソルを使用してデータベースから請求書を送信するアプリケーションを想像してください。 15 分ごとに実行し、最大 14 分間請求書のみを処理する [scheduled task](/docs/master/scheduling) を定義できます。
