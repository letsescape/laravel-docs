...
Boost は、モデル コンテキスト プロトコルをサポートする一般的な IDE および AI ツールと統合します。 Cursor、Claude Code、Codex、Gemini CLI、GitHub Copilot、および Junie の詳細なセットアップ手順については、Boost ドキュメントの [Set Up Your Agents](/docs/master/boost#set-up-your-agents) セクションを参照してください。
