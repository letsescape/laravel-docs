...
`__` 関数は、[language files](/docs/11.x/localization) を使用して、指定された翻訳文字列または翻訳キーを翻訳します。
...
`Str::doesntContain` メソッドは、指定された文字列に指定された値が含まれていないかどうかを判断します。デフォルトでは、このメソッドは大文字と小文字を区別します。
...
`Str::plural` メソッドは、単数形の単語文字列を複数形に変換します。この関数は [any of the languages support by Laravel's pluralizer](/docs/11.x/localization#pluralization-language) をサポートします。
...
`Str::pluralStudly` メソッドは、大文字小文字でフォーマットされた単数形の単語文字列を複数形に変換します。この関数は [any of the languages support by Laravel's pluralizer](/docs/11.x/localization#pluralization-language) をサポートします。
...
`Str::singular` メソッドは、文字列を単数形に変換します。この関数は [any of the languages support by Laravel's pluralizer](/docs/11.x/localization#pluralization-language) をサポートします。
...
`trans` 関数は、[language files](/docs/11.x/localization) を使用して、指定された変換キーを変換します。
...
`plural` メソッドは、単数形の単語文字列を複数形に変換します。この関数は [any of the languages support by Laravel's pluralizer](/docs/11.x/localization#pluralization-language) をサポートします。
...
`singular` メソッドは、文字列を単数形に変換します。この関数は [any of the languages support by Laravel's pluralizer](/docs/11.x/localization#pluralization-language) をサポートします。
