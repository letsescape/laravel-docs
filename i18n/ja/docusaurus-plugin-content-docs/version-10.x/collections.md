...
この方法は、[views](/docs/10.x/views) などのグリッド システムを操作する場合、[Bootstrap](https://getbootstrap.com/docs/4.1/layout/grid/) で特に便利です。たとえば、グリッドに表示したい [Eloquent](/docs/10.x/eloquent) モデルのコレクションがあるとします。
