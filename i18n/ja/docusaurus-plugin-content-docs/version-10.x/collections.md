...
この方法は、[views](https://getbootstrap.com/docs/4.1/layout/grid/) などのグリッド システムを操作する場合、[Bootstrap](/docs/10.x/views) で特に便利です。たとえば、グリッドに表示したい [Eloquent](/docs/10.x/eloquent) モデルのコレクションがあるとします。
