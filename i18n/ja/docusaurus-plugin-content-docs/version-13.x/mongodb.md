...
- [GridFS へのファイルの保存](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/filesystems/)、[フライシステム用 GridFS アダプター](https://flysystem.thephpleague.com/docs/adapter/gridfs/) 経由。
