...
Laravelドキュメントのオンライン版は [https://laravel.com/docs](https://laravel.com/docs) で確認できます。
...
**現在の安定版リリース**向けのドキュメントを提出する場合は、対応するブランチへ提出してください。たとえば、Laravel 12 のドキュメントであれば `12.x` ブランチへ提出します。Laravel の次期リリース向けのドキュメントは、`master` ブランチへ提出してください。
