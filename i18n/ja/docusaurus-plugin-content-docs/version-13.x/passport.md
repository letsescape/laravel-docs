...
アプリケーションが [コントローラミドルウェアの属性](/docs/{{version}}/controllers#middleware-attributes) を使用する場合、Passportのスコープ ミドルウェアの便利なショートカットとして `Laravel\Passport\Attributes\AuthorizeToken` 属性を使用できます。
