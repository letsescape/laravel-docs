...
この方法は、[views](https://getbootstrap.com/docs/5.3/layout/grid/) などのグリッド システムを操作する場合、[Bootstrap](/docs/13.x/views) で特に便利です。たとえば、グリッドに表示したい [Eloquent](/docs/13.x/eloquent) モデルのコレクションがあるとします。
