...
デフォルトでは、Laravel はデータをハッシュするときに `bcrypt` ハッシュドライバを使用します。ただし、[argon2id](https://en.wikipedia.org/wiki/Argon2) や [argon2id](https://en.wikipedia.org/wiki/Argon2) など、他のいくつかのハッシュ ドライバがサポートされています。
