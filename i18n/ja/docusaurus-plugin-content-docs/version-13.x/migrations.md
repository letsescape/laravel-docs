...
このメソッドは、多態性 [Eloquent リレーション](/docs/{{version}}/eloquent-relationships) に必要な列を定義するときに使用することを目的としています。次の例では、`taggable_type` 列と `taggable_id` 列が作成されます。
...
このメソッドは、ULID 識別子を使用する多態性 [Eloquent リレーション](/docs/{{version}}/eloquent-relationships) に必要な列を定義するときに使用することを目的としています。次の例では、`taggable_type` 列と `taggable_id` 列が作成されます。
...
このメソッドは、UUID 識別子を使用する [多様なEloquent リレーション](/docs/{{version}}/eloquent-relationships#polymorphic-relationships) に必要な列を定義するときに使用することを目的としています。次の例では、`taggable_type` 列と `taggable_id` 列が作成されます。
